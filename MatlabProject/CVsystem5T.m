...
%cam.Brightness=-30;%调整相机亮度

cam1=webcam(2);
%preview(cam1);
cam1.Resolution='1920x1080';
%cam1.Brightness=-50;%调整相机亮度
%cam1.Exposure=-20;
...
las_dist =197; %135; % Laser Plane parameters
...
CVsyst_x1 = 86; %76 CV System second position 在unity中为CVSystemOrigin2的位置参数z*1000
CVsyst_y1 = 257; % CV System second position 在unity中为CVSystemOrigin2的位置参数x*-1000
CVsyst_rot1 = -90;%20; % CV System second rotation 在unity中为CVSystemOrigin2的位置参数Rotation Y
las_dist1 =189; %138; % Laser Plane parameters
% Mapping
