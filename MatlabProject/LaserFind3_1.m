...
upper_red5 = [0.1, 0.2, 1];%[0.2, 0.5, 1];
...
% 对掩膜进行形态学操作（膨胀和腐蚀）figure;imshow(redMask5);
...
combinedImage =  cleanedImage |cleanedImage5;%| cleanedImage6;
% 对掩膜进行形态学操作（膨胀和腐蚀）
