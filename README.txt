...
PROJECT RESOURCES
Video Demonstration:
https://www.bilibili.com/video/BV1Jz9RBXEKj/?spm_id_from=333.1387.homepage.video_card.click
...
MATLAB Image Processing & Localization
...
Ensure the Unity server script is configured to match the MATLAB client variable.

Both systems must be set to communicate over Port 55019 (127.0.0.1).
